...
@section('js')
    <!-- Page Plugins -->
    <script src="{{asset('themes/assets/js/plugins/slick/slick.min.js')}}"></script>
    <script src="{{asset('themes/assets/js/plugins/chartjs/Chart.min.js')}}"></script>
    <script src="{{asset('themes/assets/js/plugins/flot/jquery.flot.min.js')}}"></script>
    <script src="{{asset('themes/assets/js/plugins/flot/jquery.flot.pie.min.js')}}"></script>
    <script src="{{asset('themes/assets/js/plugins/flot/jquery.flot.stack.min.js')}}"></script>
    <script src="{{asset('themes/assets/js/plugins/flot/jquery.flot.resize.min.js')}}"></script>

    <!-- Page JS Code -->
    <script src="{{asset('themes/assets/js/pages/index.js')}}"></script>
    <script>
        $(function () {
...
@section('css')
    <!-- Page JS Plugins CSS -->
    <link rel="stylesheet" href="{{asset('themes/assets/js/plugins/slick/slick.min.css')}}" />
    <link rel="stylesheet" href="{{asset('themes/assets/js/plugins/slick/slick-theme.min.css')}}" />
@stop
@section('content')
    <!-- Stats -->
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-lg-3 b-r">
                            ...
                            <div class="progress progress-mini m-b-sm">
                                <div class="progress-bar progress-bar-green" role="progressbar" aria-valuenow="76"
                        ...
                        <div class="col-xs-6 col-lg-3 b-r visible-lg">
                            ...
                            <div class="progress progress-mini m-b-sm">
                                <div class="progress-bar progress-bar-green" role="progressbar" aria-valuenow="84"
                        ...
                        <div class="col-xs-6 col-lg-3 b-r visible-lg">
                            ...
                            <div class="progress progress-mini m-b-sm">
                                <div class="progress-bar progress-bar-green" role="progressbar" aria-valuenow="74"
                                     aria-valuemin="0" aria-valuemax="100" style="width: 74%"></div>
                            </div>
                        </div>
                        <div class="col-xs-6 col-lg-3">
                            ...
                            <div class="progress progress-mini m-b-sm">
                                <div class="progress-bar progress-bar-green" role="progressbar" aria-valuenow="90"
