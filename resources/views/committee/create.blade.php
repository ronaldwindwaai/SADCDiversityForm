            ...
            <div class="card-block">
                ...
                <form class="form-horizontal" action="{{route('committee.store')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            <input class="form-control" type="text" id="committee-name" name="name" placeholder="Enter Committee Name...">
                        </div>
                    </div>

                    <div class="form-group m-b-0">
                        <div class="col-xs-12">
                            <button class="btn btn-app" type="submit">Create Committee</button>
                        </div>
                    </div>
                </form>
            </div>
